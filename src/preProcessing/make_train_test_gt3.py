...
g_bip = ig.Graph().Read_GraphMLz(networks_dir + "/sample_gt3.graphmlz")
...
g_bip.write_graphmlz(f=networks_dir + "/gt3_sample_90perc_edges.graphmlz")
np.save(networks_dir + "/gt3_sample_10perc_edges.npy", drop_edges)